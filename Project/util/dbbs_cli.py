...
def print_help():
    ...
    print("python dbbs_cli.py <команда> <параметр_1> <параметр_2> <параметр_3>")
    print("Команды:")
    print("   -b - выполнить замер производительности,")
    print("        <параметр_1> - код группы запросов")
    print("        <параметр_2> - наименование замера производительности")
    print("        <параметр_3> - код соединения со вспомогательной БД")
    print("   -r - вывести результаты замера производительности,")
    print("        <параметр_1> - наименование замера производительности")
    print("   -c - сравнить два замера производительности")
    print("        <параметр_1> - наименование замера производительности № 1")
    print("        <параметр_2> - наименование замера производительности № 2")
